...
- par importation d'un fichier de données dans R,
...
```{r, messages=FALSE, warning=FALSE}
# data.frame "df_statis", l'élément situé 1ère ligne, 2ème colonne
df_statis[1, 2]
...
- de type caractère (elles ne contiennent que des chaines de caractère)  
...
Pour le data.frame "df_statis", nous vous proposons de re-modifier le type de la colonne "nom" en "character"
...
# Afficher le nouveau type de la colonne "nom"
...
df_statis <- mutate(
  df_statis,
  # pour chaque ligne, je teste si nom = IcaRius
...
# Dans le data.frame "df_statis", 
# le nombre de coeurs d'IcaRius a été sous-estimé d'une unité. 
# Modifier la colonne "coeurs" du data.frame pour qu'elle contienne les vraies valeurs, avec le sortilège "ifelse"


# afficher le data.frame modifié


# Afficher le nombre de coeurs d'IcaRius, en sélectionnant avec les crochets le bon élément du data.frame "df_statis"
