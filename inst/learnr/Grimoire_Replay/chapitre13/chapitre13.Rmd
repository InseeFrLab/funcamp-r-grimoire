...
# tous les sortilèges du projet avec "load_all()" du package "devtools"
library(devtools)
load_all()
...
Les fichiers RMarkdown permettent de créer des documents (rapports, présentations, tableaux de bord) :  
- avec une belle présentation,  
- qui peuvent comprendre :  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;du texte,  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;du code dans le langage des Runes,  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ainsi que les résultats de l'éxécution du code (les chiffres produits, les graphiques réalisés, etc.).  
...
A l'intérieur des fichiers RMarkdown on alterne la prise de note et le code R.  

Les lieux où taper du code 
sont matérialisés par une zone grisée dans RStudio :  

![](./images/premier_chunk.png){width=80%} 
...
A l'exécution du fichier ".Rmd", les calculs sont menés, les graphiques éventuels sont réalisés, et un document est produit.  
Chaque nouvelle exécution met à jour le document (si le fichier ".Rmd" a été modifié ou si les données ont changé).

<BR>

Le document produit est au format html.  
Il apparaît dans le même répertoire que le fichier `.Rmd` .  

![](./images/age_Icarius.png.png){width=80%} 
...
question("Quel est le type de fichiers, qui permet de créer des rapports qui contiennent prise de notes, code R, et résultats, avec une belle présentation ?",
type="single",
allow_retry = TRUE,
incorrect="Retente ta chance",
answer(""),
...
answer("Le type \".txt\""),
correct="Félicitations, ce sont bien les fichiers de type \".Rmd\", qui à l'exécution peuvent produire de tels rapports"
)
