...
De nouveau, une relation se dessine entre les deux variables, tout en présentant une certaine dispersion. D'ailleurs, la forme globale du nuage est assez similaire à la précédente. Voilà qui invite à étudier de plus près la liaison entre puissance et âge...
...
Comme le sortilège peut comporter de nombreux ingrédients, nous allons dorénavant les appeler par leur nom consciencieusement, ici : `title = `. 
