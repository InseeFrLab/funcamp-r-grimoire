...
# Par défaut, la fonction donne comme résultat la valeur de "variable3"
```
...
## f_2 a bien renvoyé la valeur de z, dernière expression évaluée.
...
# "f_2" a bien renvoyé la valeur de y.
```
...
# Calculer la nouvelle valeur de f_2(0)
...
## A l'exécution :
## - f_2(0) renvoie bien la valeur de y.
## - après avoir rencontré "return(...)", le système quitte la fonction,
##   et le code  z = 3 + x  n'est pas exécuté
```

<BR>

## A l'utilisation d'une fonction

<BR>

A l'emploi d'une fonction, quelles sont les diverses façons de préciser les ingrédients ?

<BR>

#### Il est possible de nommer ou non les paramètres
...
Par contre, si les ingrédients sont nommés l'ordre des paramètres peut être changé.
...
## Le résuktat n'est plus en erreur, 
## la valeur par défaut de sep, " " a bien été prise en compte.
...
## Le résultat n'est plus en erreur. 
## La valeur par défaut de sep, " " est prise en compte.
