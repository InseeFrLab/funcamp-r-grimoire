...
file.copy(from = system.file(package = "funcampR","data","chapitre2/pontes_semaine1.sas7bdat"),
          to = paste0(tempdir(),"/pontes_semaine1.sas7bdat"))
file.copy(from = system.file(package = "funcampR","data","chapitre2/pontes_semaine2.xls"),
          to = paste0(tempdir(),"/pontes_semaine2.xls"))
file.copy(from = system.file(package = "funcampR","data","chapitre2/pontes_semaine3.ods"),
          to = paste0(tempdir(),"/pontes_semaine3.ods"))
file.copy(from = system.file(package = "funcampR","data","chapitre2/pontes_semaine4.csv"),
          to = paste0(tempdir(),"/pontes_semaine4.csv"))
...
```{r, echo=FALSE}
livre_compte_1 <- import(paste0(tempdir(),"/pontes_semaine1.sas7bdat"))
```
...
livre_compte_2 <- import(paste0(tempdir(),"/pontes_semaine2.xls"))
```
...
```{r, echo=FALSE}
livre_compte_4 <- import(paste0(tempdir(),"/pontes_semaine4.csv"))
```
