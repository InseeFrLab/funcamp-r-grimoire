...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;champ "Directory Name:" renseigner le nom du projet, par exemple projet1 ,  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;champ "Create project as subdirectory of:" choisir le répertoire parent du projet,  
...
dans la page suivante renseigner le nom du projet, par exemple projet2, dans le champ "Package Name:" .
...
Ci-dessous le contenu du répertoire `projet2` :  

![](./images/projet2.png){width=30%} 

Le dossier `projet2` inclut des sous-répertoire `R` et `man`.

<BR>

<BR>
 
Le sous-répertoire `R` contient un script R exemple `hello.R`.
...
Ci-dessous le sous-répertoire `man` :

![](./images/projet2_man.png){width=100%} 
 
Ce dossier `man` sert à contenir des fichiers ".Rd" (de documentation).  
