...
In the world of Statis, age follows a somewhat strange logic. At birth, the statisians have for age their number of lives multiplied by the number pi squared, from which we subtract the maximum number of lives that they will be able to have during their journey… To facilitate the whole, one will admit to take the rounding of the result...
