...
Ce registre est déjà chargé, dans le data.frame `naissances`. Nous savons employer 
les instructions `names()` pour avoir le noms des variables, `head()` pour consulter les premiers enregistrements, et `nrow()`
